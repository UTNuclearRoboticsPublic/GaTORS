...
public:
    ...
    void instantiateBoard (const std::string &move_dir, const float &move_discretization, sensor_msgs::msg::PointCloud2 &move_board, const std::string &repair_dir, const float &repair_discretization, sensor_msgs::msg::PointCloud2 &repair_board);
